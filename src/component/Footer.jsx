...
const Footer = () => {
  return (
    <div>
      <footer className="footer sm:footer-horizontal bg-gray-800 text-neutral-content items-center justify-between p-10 lg:px-20 ">
        ...
        <div>
          ...
          <p>Email: walidulislam2005@gmail.com</p>
          <p>Phone: +8801854475196</p>
          <p>Address: Barisal, Bangladesh</p>
        </div>
        <nav>
